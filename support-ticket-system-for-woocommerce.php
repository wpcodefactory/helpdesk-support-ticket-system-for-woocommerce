...
defined( 'WPFACTORY_WC_STS_VERSION' ) || define( 'WPFACTORY_WC_STS_VERSION', '2.2.0-dev-20260917-1503' );
...
if ( ! class_exists( 'STSWooCommerce' ) ) :
	 ...
	 * @version 2.2.0
	 */
	class STSWooCommerce extends WPFactory_WC_STS_Init {
